...
dependencies {
    ...
    implementation("androidx.compose.foundation:foundation-layout:1.6.0-beta02")
    implementation("androidx.compose.foundation:foundation-layout-android:1.6.0-beta02")
    implementation(platform("androidx.compose:compose-bom:2023.10.01"))
    implementation(platform("androidx.compose:compose-bom:2023.10.01"))
    implementation(platform("androidx.compose:compose-bom:2023.10.01"))
