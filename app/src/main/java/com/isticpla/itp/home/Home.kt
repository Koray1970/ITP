...
fun Home(
    ...
    val shopScaffoldState = rememberBottomSheetScaffoldState()

    val listofShops = homeViewModel.shopList.collectAsState(initial = emptyList())
    val getselectedShop =
        homeViewModel.selectedShop.collectAsStateWithLifecycle(initialValue = mutableStateOf( dummyshop))
    var (selectedShopOption, onOptionSelectedShop) = remember { dummyshop }


    BottomSheetScaffold(
        scaffoldState = shopScaffoldState,
                                ...
                                .selectable(
                                    ...
                                    onClick = {
                                        scope.launch {
                                            ...
                                            shopScaffoldState.bottomSheetState.partialExpand()
                                        }
                                    },
        ...
        { innerpadding ->
            Column(
                ...
                if (listofShops.value.isNotEmpty())
                    HomeSectionHeader(shopScaffoldState)
